[Prev](DeveloperCodingGuideline.html) (Coding Guideline) | [Home](Home.html) | [Manual](DocMain.html) | (Add translations) [Next](DeveloperTranslate.html)
- - -
...
- Configure 
    ...
    - Only change the UPDATE_TRANSLATIONS option in you know what you are doing. See the [DeveloperTranslate Wiki page](DeveloperTranslate.html) for details.
...
## TroubleShooting
If QMapShack does not behave as you expect, please have a look at the [TroubleShooting Wiki Page](TroubleShooting.html). If this does not help you to understand the problem, you can try to dig deeper by debugging as described in the next section.
