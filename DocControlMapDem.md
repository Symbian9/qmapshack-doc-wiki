...
You can control with the checkboxes what major map elements are displayed. For example you can overlay your raster map with a vector map and display the points of interest only to add more information to your map. 
